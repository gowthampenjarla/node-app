...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsCategoriesCategoriesComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"container\">\n  <flash-messages></flash-messages>\n  <div class=\"card card-body mt-4\" *ngIf=\"showcat\">\n    <h5 class=\"card-title\">Categories</h5>\n    <div class=\"list-group\">\n      <div class=\"list-group-item d-flex justify-content-between align-items-center\"\n        *ngFor=\"let category of categoryList\">\n        <a (click)='onSelect(category.category)' href=\"#\">{{category.category}}</a>\n        <!-- <span class=\"log-date\">{{category.date | date: 'medium'}}</span> -->\n        <button class=\"btn btn-danger\" (click)=\"onDelete(category.category)\">X</button>\n      </div>\n    </div>\n  </div>\n</div>\n\n\n<div class=\"container mt-4\" *ngIf=\"showProduct\">\n  <div class=\"card card-body\">\n    <h5 class=\"card-title\">Products</h5>\n    <div class=\"list-group\">\n      <div class=\"list-group-item\" *ngFor=\"let product of productList\">\n        {{product.product}}\n      </div>\n    </div>\n  </div>\n</div>\n\n<!-- routerLink=\"/category/{{category.category}}\"\nrouterLinkActive=\"router-link-active\" -->\n";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsNavbarNavbarComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div class=\"navbar navbar-expand navbar-dark mb-3 p-3\" style=\"background-color: #512da8;\">\n  <div class=\"container\">\n    <a href=\"#\" class=\"navbar-brand h1 mb-0\">Node App</a>\n  </div>\n</div>\n";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var angular2_flash_messages__WEBPACK_IMPORTED_MODULE_8___default =
    /*#__PURE__*/
    __webpack_require__.n(angular2_flash_messages__WEBPACK_IMPORTED_MODULE_8__);
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_5__["NavbarComponent"], _components_categories_categories_component__WEBPACK_IMPORTED_MODULE_6__["CategoriesComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_8__["FlashMessagesModule"].forRoot()],
      providers: [],
  ...
  function srcAppComponentsCategoriesCategoriesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_action_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function CategoriesComponent(_actionService, _route, _flashMessagesService) {
      ...
      _createClass(CategoriesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this._actionService.getCategories().subscribe(function (res) {
            _this.categoryList = res;

            if (_this.categoryList.length == 0) {
              _this.showcat = false;

              _this._flashMessagesService.show("There are no categories. Please create categories.", {
        ...
        value: function onSelect(category) {
          ...
          this._actionService.getProducts(category).subscribe(function (res) {
            _this2.productList = res;

            if (_this2.productList.length !== 0) {
              _this2.showProduct = true;
            }
          });
        }
      }, {
        ...
        value: function onDelete(category) {
          ...
          this._actionService.deleteProducts(category).subscribe(function (res) {
            _this3._flashMessagesService.show("Products are deleted for category ".concat(category, "!"), {
              cssClass: 'alert-danger',
              timeout: 3000
            });

            _this3.showProduct = false;
    ...
    CategoriesComponent.ctorParameters = function () {
      return [{
        type: _services_action_service__WEBPACK_IMPORTED_MODULE_2__["ActionService"]
      }, {
  ...
  function srcAppServicesActionServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ActionService, [{
        ...
        value: function getProducts(category) {
          ...
          return this._http.get("http://localhost:3000/categories/".concat(category), options);
        }
      }, {
        key: "deleteProducts",
        value: function deleteProducts(category) {
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json'
          });
          var options = {
          ...
          return this._http.delete("http://localhost:3000/categories/delCat/".concat(category), options);
        }
      }]);
    ...
    ActionService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], ActionService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\penja\Documents\Coding_WorkSpace\Appiness Assesment\node-app\angular-ui\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
